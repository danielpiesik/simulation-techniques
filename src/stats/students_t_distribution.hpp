#ifndef STUDENTS_T_DISTRIBUTION_HPP
#define STUDENTS_T_DISTRIBUTION_HPP

double st_distribution(int i,int j)
{
  static double student_t_distribution[31][5] =
  {
    ...
    { 1.282,  1.645,  1.960,  2.326,  2.576 }  // 30
  };

  --i;
  if((i < 0) || (j < 0) || ( j > 4)) return 0;
  if(i > 30) i = 30;
...
co  1.282  1.645  1.960  2.326  2.576
*/

#endif // STUDENTS_T_DISTRIBUTION_HPP
